...
void verificarTransmision(){
    ...
    if(segundosTX % MAX_TIME_TX == 0){     //00,10,20,30,40,50,00
        ...
        if(!lstTransmitir.isEmpty () && !lstVerificaciones.isEmpty () && strRetransmitir.length() == 0)  {
            strRetransmitir = lstTransmitir.pop();
            verificarEstado = lstVerificaciones.pop();  
            vecesTX=0;
        }
...
void transmitirNuevoEVENTO(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar);    
    lstVerificaciones.push(contador.estadoACTUAL);
...
void transmitirConteoPARCIAL(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(MSG_MUESTREO_PARCIAL);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());
    transmitirEstadoACTUAL();
}
...
void transmitirConteoHORA(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(MSG_CAPTURA_CONTEOHORA);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());
    transmitirEstadoACTUAL();
}
...
void transmitirNuevaPRODUCCION(){
    ...
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(PRD_NUEVA_PRODUCCION);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());         
}
...
void transmitirIniciarPRODUCCION(){
    ...
    //strComunicar.replace((char)127,(char)209); strComunicar.replace((char)128,(char)241);     
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(PRD_INICIA_PRODUCCION);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());
}
...
void  transmitirFinalizarPRODUCCION(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(PRD_FINALIZO_PRODUCCION);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());   
}
...
void transmitirContadorENCENDIDO(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(MSG_CONTADOR_ENCENDIDO);
    writeSDCardEVNT(strComunicar); 
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());   
}
...
void transmitirContinuaCONTEO(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(PRD_PRODUCIENDO);
    writeSDCardEVNT(strComunicar); 
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());       
}
void transmitirContinuaPRODUCCION(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(MSG_CONTINUA_PRODUCCION);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());   
} 
void transmitirContadorDETENIDO(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(PRD_PRODUCCION_DETENIDA);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());   
} 
void transmitirReseteaCONTADOR(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar); 
    lstVerificaciones.push(MSG_RESETEA_CONTADOR);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());    
} 
void transmitirReseteaPRODUCCION(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar); 
    lstVerificaciones.push(MSG_RESETEA_PRODUCCION);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());    
} 
void transmitirCancelarPRODUCCION(){
    ...
    strComunicar += ("|");    
    lstTransmitir.push(strComunicar);
    lstVerificaciones.push(MSG_CANCELAR_PRODUCCION);
    writeSDCardEVNT(strComunicar);
    //myFrame.setText(lblBufferTX       ,(String) lstTransmitir.count());   
}
/*----------------------------------------------------------------*/
