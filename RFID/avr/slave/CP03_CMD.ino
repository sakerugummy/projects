...
void ejecutarComando(){
    ...
    if (comando == "LOTE"){
        if (parametro == "??")
            ...
            if (parametro =="?"){
                ...
                if(parametro.length()<11 && isNumeric(parametro)){
    ...
    if (comando == "TIME"){
       /*if(parametro=="??")
            ...
            if (parametro=="?")
                    respuesta+=("TIME~"+(String)myRTC.getTimeStr(FORMAT_LONG)+"|");        
            else
    ...
    if (comando == "DATE"){
        /*if(parametro=="??")  
            ...
            if (parametro=="?")
                    respuesta+=("DATE~"+(String)myRTC.getDateStr(FORMAT_LONG,FORMAT_LITTLEENDIAN,'/')+"|");        
            else
